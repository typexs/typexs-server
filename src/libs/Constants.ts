...
export const _API_STORAGE_METADATA = '/metadata';

export const _API_STORAGE_METADATA_ALL_STORES = _API_STORAGE_METADATA + '/schemas';
export const API_STORAGE_METADATA_ALL_STORES = API_STORAGE_PREFIX + _API_STORAGE_METADATA_ALL_STORES;

export const _API_STORAGE_METADATA_GET_STORE = _API_STORAGE_METADATA + '/schema/:name';
export const API_STORAGE_METADATA_GET_STORE = API_STORAGE_PREFIX + _API_STORAGE_METADATA_GET_STORE;

export const _API_STORAGE_METADATA_ALL_ENTITIES = _API_STORAGE_METADATA + '/entities';
export const API_STORAGE_METADATA_ALL_ENTITIES = API_STORAGE_PREFIX + _API_STORAGE_METADATA_ALL_ENTITIES;

export const _API_STORAGE_METADATA_CREATE_ENTITY = _API_STORAGE_METADATA + '/entity';
export const API_STORAGE_METADATA_CREATE_ENTITY = API_STORAGE_PREFIX + _API_STORAGE_METADATA_CREATE_ENTITY;

export const _API_STORAGE_METADATA_GET_ENTITY = _API_STORAGE_METADATA + '/entity/:name';
export const API_STORAGE_METADATA_GET_ENTITY = API_STORAGE_PREFIX + _API_STORAGE_METADATA_GET_ENTITY;

export const _API_STORAGE_FIND_ENTITY = '/entity/:name';
export const API_STORAGE_FIND_ENTITY = API_STORAGE_PREFIX + _API_STORAGE_FIND_ENTITY;

export const _API_STORAGE_GET_ENTITY = '/entity/:name/:id';
export const API_STORAGE_GET_ENTITY = API_STORAGE_PREFIX + _API_STORAGE_GET_ENTITY;
...
export const _API_STORAGE_SAVE_ENTITY = '/entity/:name';
export const API_STORAGE_SAVE_ENTITY = API_STORAGE_PREFIX + _API_STORAGE_SAVE_ENTITY;
...
export const _API_STORAGE_UPDATE_ENTITY = '/entity/:name/:id';
export const API_STORAGE_UPDATE_ENTITY = API_STORAGE_PREFIX + _API_STORAGE_UPDATE_ENTITY;
export const _API_STORAGE_UPDATE_ENTITIES_BY_CONDITION = '/entity/:name';
export const API_STORAGE_UPDATE_ENTITIES_BY_CONDITION = API_STORAGE_PREFIX + _API_STORAGE_UPDATE_ENTITIES_BY_CONDITION;
...
export const _API_STORAGE_DELETE_ENTITY = '/entity/:name/:id';
export const API_STORAGE_DELETE_ENTITY = API_STORAGE_PREFIX + _API_STORAGE_DELETE_ENTITY;

export const _API_STORAGE_DELETE_ENTITIES_BY_CONDITION = '/entity/:name';
export const API_STORAGE_DELETE_ENTITIES_BY_CONDITION = API_STORAGE_PREFIX + _API_STORAGE_DELETE_ENTITIES_BY_CONDITION;
