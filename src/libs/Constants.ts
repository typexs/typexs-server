...
export const _API_CTRL_STORAGE_FIND_ENTITY = '/entity/:name';
...
export const _API_CTRL_STORAGE_SAVE_ENTITY = '/entity/:name';
...
export const _API_CTRL_STORAGE_UPDATE_ENTITY = '/entity/:name/:id';
export const API_CTRL_STORAGE_UPDATE_ENTITY = API_CTRL_STORAGE_PREFIX + _API_CTRL_STORAGE_UPDATE_ENTITY;
export const _API_CTRL_STORAGE_UPDATE_ENTITIES_BY_CONDITION = '/entity/:name';
...
export const _API_CTRL_STORAGE_DELETE_ENTITY = '/entity/:name/:id';
export const API_CTRL_STORAGE_DELETE_ENTITY = API_CTRL_STORAGE_PREFIX + _API_CTRL_STORAGE_DELETE_ENTITY;

export const _API_CTRL_STORAGE_DELETE_ENTITIES_BY_CONDITION = '/entity/:name';
...
// Get method
export const _API_CTRL_DISTRIBUTED_STORAGE_FIND_ENTITY = '/query/:name';
...
// Post method
export const _API_CTRL_DISTRIBUTED_STORAGE_SAVE_ENTITY = '/entity/:nodeId/:name';
...
// Post method
export const _API_CTRL_DISTRIBUTED_STORAGE_UPDATE_ENTITY = '/entity/:nodeId/:name/:id';
export const API_CTRL_DISTRIBUTED_STORAGE_UPDATE_ENTITY =
  API_CTRL_DISTRIBUTED_STORAGE +
  _API_CTRL_DISTRIBUTED_STORAGE_UPDATE_ENTITY;

// Put method
export const _API_CTRL_DISTRIBUTED_STORAGE_UPDATE_ENTITIES_BY_CONDITION = '/entity/:nodeId/:name';
...
// Delete method
export const _API_CTRL_DISTRIBUTED_STORAGE_DELETE_ENTITY = '/entity/:nodeId/:name/:id';
export const API_CTRL_DISTRIBUTED_STORAGE_DELETE_ENTITY =
  API_CTRL_DISTRIBUTED_STORAGE +
  _API_CTRL_DISTRIBUTED_STORAGE_DELETE_ENTITY;

export const _API_CTRL_DISTRIBUTED_STORAGE_DELETE_ENTITIES_BY_CONDITION = '/entity/:nodeId/:name';
