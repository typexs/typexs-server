...
import {
  ...
  PERMISSION_ALLOW_DELETE_STORAGE_ENTITY_PATTERN, PERMISSION_ALLOW_DISTRIBUTED_STORAGE_SAVE_ENTITY,
  ...
  PERMISSION_ALLOW_WORKERS_INFO, PERMISSION_ALLOW_DISTRIBUTED_STORAGE_UPDATE_ENTITY, PERMISSION_ALLOW_DISTRIBUTED_STORAGE_DELETE_ENTITY
} from './libs/Constants';
